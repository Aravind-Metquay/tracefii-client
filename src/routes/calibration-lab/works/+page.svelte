<script>
    ...
    import WorksTable from "@/application-components/calibration-lab/works/works-table.svelte";
</script>


<svelte:head>
    <title>Works | All works</title>
...
<main class="w-full h-full">
    <div class="p-2 flex items-center justify-between border-b">
        <div class="flex items-center p-2 gap-2">
            <Building2  size="16"/>
            <p class="font-semibold">Works</p>
            <Tooltip position="right" text="View all your works here">
                <Info size="12"/>
            </Tooltip>
        </div>
        <div>
