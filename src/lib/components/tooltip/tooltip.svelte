<script lang="ts">
	import { getStringWidth } from '@/components/utils/text.js';
...
<span>
	<span
		class="w-auto group relative cursor-pointer text-kui-light-gray-1000 dark:text-kui-dark-gray-1000 {_class}"
	>
		{#if children}
			{@render children?.()}
		{/if}
