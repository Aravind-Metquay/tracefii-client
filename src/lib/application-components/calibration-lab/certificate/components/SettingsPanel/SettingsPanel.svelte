...
<div class="bg-white">
	<div class="p-6">
		...
		<div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
			...
			<h3 class="mb-3 mt-2 text-lg font-semibold text-gray-900">
			...
			<div class="space-y-3">
				...
				<div>
					...
					<input
						id="margin-default"
						type="number"
						bind:value={certificate.page.margin.margin}
				...
				<div class="grid grid-cols-2 gap-4">
					<div>
						<label for="margin-top" class="mb-2 block text-sm font-medium text-gray-700"
							>Top</label
						>
						<input
							id="margin-top"
				...
				<div class="grid grid-cols-2 gap-4">
					...
					<div>
						<label for="margin-left" class="mb-2 block text-sm font-medium text-gray-700"
							>Left</label
						>
						<input
							id="margin-left"
