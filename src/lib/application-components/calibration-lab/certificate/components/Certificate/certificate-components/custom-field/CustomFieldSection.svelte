...
// });
    ...
    // Reset image states when field changes
    $effect(() => {
            ...
            <div class="custom-table">
                <table>
                    {#if customField.content.headers && customField.content.headers.length > 0}
                        <thead>
                            <tr>
                                {#each customField.content.headers as header, i (i)}
                                    <th>{header}</th>
                                {/each}
                            </tr>
                        </thead>
                    {/if}
                    <tbody>
                        {#each customField.content.rows || [] as row, rowIndex (rowIndex)}
                            <tr>
                ...
                {#if customField.content.src}
                    <div class="image-container">
                        ...
                        <img
                            ...
                            style="max-width: {customField.content.maxWidth || '100%'}; height: auto; {!imageLoaded ? 'display: none;' : ''}"
                        ...
                        {#if imageError}
                            <div class="image-error">
                                ...
                                <p class="error-url">{customField.content.src}</p>
                            </div>
                        {/if}
                    </div>
                {:else}
...
<style>
    ...
    .custom-image img {
        ...
        max-height: 500px; /* Prevent extremely large images */
    }
