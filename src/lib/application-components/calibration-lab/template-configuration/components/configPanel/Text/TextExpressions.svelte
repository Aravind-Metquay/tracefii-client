<script lang="ts">
	...
	import { textVariables, dateVariables } from '../../../lib/dynamicVariables';
...
{#if showSuggestions && position}
	<div
		class="scrollbar-thin scrollbar-track-slate-100 scrollbar-thumb-slate-300 hover:scrollbar-thumb-slate-400 pointer-events-auto fixed z-[10000] max-h-[300px] w-[280px] overflow-x-hidden overflow-y-auto rounded-md border border-gray-300 bg-white shadow-lg"
